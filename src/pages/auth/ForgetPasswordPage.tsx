...
const ForgetPasswordPage = () => {
    ...
    return (
        ...
        >
            {/* Title */}
            <Stack>
                <Typography variant='h4' sx={{ color: 'neutral.dark', textAlign: 'center' }}>忘記您的密碼?</Typography>
                <Typography variant='caption' sx={{ color: 'neutral.main', mt: 1, textAlign: 'center' }}>請輸入帳號註冊的電子郵件</Typography>
            </Stack>
            <Stack sx={{ gap: '2rem' }}>
                {/* Email */}
